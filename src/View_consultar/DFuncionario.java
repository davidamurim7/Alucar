 ...
 * @author David
 */
public class DFuncionario extends javax.swing.JDialog {

    /**
     * Creates new form DFuncionario
     */
    public DFuncionario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void preencherTabela(){
        ...
        for(Funcionario f : listaFuncionario){
                ...
                jTFuncionarios.setValueAt(f.getNome(), i, 0);
                jTFuncionarios.setValueAt(f.getNivel(), i, 1);
                jTFuncionarios.setValueAt(f.getAtivo(), i, 2);
                i++;
        }
    ...
    private void initComponents() {
        ...
        jTFuncionarios.setSelectionBackground(new java.awt.Color(0, 102, 102));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DFuncionario dialog = new DFuncionario(new javax.swing.JFrame(), true);
