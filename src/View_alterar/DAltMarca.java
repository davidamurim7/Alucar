 ...
 * @author David
 */
public class DAltMarca extends javax.swing.JDialog {

    /**
     * Creates new form DAltMarca
     */
    public DAltMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jCMarca.getSelectedIndex() > 0) {
            ...
            if (marcaDAO.altMarca(marca)) {
                limparMarcas();
                JOptionPane.showMessageDialog(rootPane, "Marca Atualizada!", "SUCESSO", JOptionPane.INFORMATION_MESSAGE);
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DAltMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DAltMarca dialog = new DAltMarca(new javax.swing.JFrame(), true);
