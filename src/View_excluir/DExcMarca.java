 ...
 * @author David
 */
public class DExcMarca extends javax.swing.JDialog {

    /**
     * Creates new form DExcMarca
     */
    public DExcMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jCMarca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione uma marca" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jCMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 439, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jCMarca.getSelectedIndex() > 0) {
            Connection conexao = Conexao.conectar();
            MarcaDAO marcaDAO = new MarcaDAO(conexao);
            Marca marca = marcaDAO.selecionaMarca((String) jCMarca.getSelectedItem());
            marca.setDescricao(jTDescricao.getText());
            if (marcaDAO.delMarca(marca)) {
                limparMarcas();
                jCMarca.removeItem(marca.getNome());
                JOptionPane.showMessageDialog(rootPane, "Marca excluída!", "SUCESSO", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(rootPane, "Erro inesperado", "ERRO", JOptionPane.ERROR_MESSAGE);
            }
            Conexao.desconectar(conexao);
        } else {
            JOptionPane.showMessageDialog(rootPane, "Selecione uma marca", "ERRO", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DExcMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DExcMarca dialog = new DExcMarca(new javax.swing.JFrame(), true);
